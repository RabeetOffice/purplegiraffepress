...
<section class="section figma-cream">
  <div class="container section-heading center">
    ...
    <h2>Complete Children&rsquo;s Book Services To Support Your Publishing Journey</h2>
    <p style="margin:14px auto 0;">What your project includes depends on your goals. We offer a full suite of professional services tailored to the specific needs of children&rsquo;s literature.</p>
  </div>
  <div class="container">
    <?php $services_only = ['editing', 'book-cover-design', 'book-promotion', 'custom-illustrations', 'ghostwriting', 'author-websites']; include 'includes/services.php'; ?>
  </div>
</section>
